...
@Component({
  selector: 'app-sub-project-document-tasks',
  templateUrl: './sub-project-document-tasks.component.html',
  styleUrls: ['./sub-project-document-tasks.component.css']
})
export class SubProjectDocumentTasksComponent implements OnInit {
  ...
  getAllRequests() {
    ...
    this._projectServices.getSubProjectTasks().subscribe(
      (result: any) => {
